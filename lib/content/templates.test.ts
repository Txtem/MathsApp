...
describe("Der Content als Ganzes", () => {
   ...
   *
   * `kombinatorik.permutation.multiset` war zwischen Schritt 1 und Schritt 3 von
   * M2d die eine Ausnahme: `aufg_00004` hatte sie gegen `…​.wort` getauscht.
   * `aufg_00014` (Kugeln) deckt sie wieder ab, die Ausnahme ist weg.
   */
