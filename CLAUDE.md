...
| DB | PostgreSQL (Neon oder Supabase) | Relationale Daten, kein Grund für NoSQL |
...
Next.js + Prisma + Postgres aufgesetzt. Zwei hartcodierte Templates (Addition, Subtraktion).
